...
export default class Play extends React.Component {
  ...
  _onPress = () => {
    ...
    if (delta < 200) {
      ...
      if (playlist.length === 0 && !downloading) this._downloadRecommendations()
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <TouchableHighlight onPress={this._onPress} underlayColor="white" style={{ flex: 1, backgroundColor: 'white' }}>
          <View style={{ flex: 1 }}>
